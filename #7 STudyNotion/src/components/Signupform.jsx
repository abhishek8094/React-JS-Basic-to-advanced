    ...
    <div>
      <div className="flex bg-slate-800 w-fit py-2 px-1 rounded-full gap-x-2">
        <div
          ...
          className={`py-2 px-4 font-semibold font-base rounded-full cursor-pointer ${
            group === "student" ? "bg-black" : "bg-transparent"
          }`}
        >
          Student
        </div>
        <div
          onClick={() => setGroup("instructor")}
          className={`py-2 px-4 font-semibold font-base rounded-full cursor-pointer ${
            group === "instructor" ? "bg-black" : "bg-transparent"
          }`}
        >
          Instructor
        </div>
